...
-- dead delete
vim.api.nvim_set_keymap("v", "<leader>md", '"_d', kopts)

-- Comments
vim.api.nvim_set_keymap("n", "<leader>/", ":CommentToggle<CR>", kopts)
vim.api.nvim_set_keymap("v", "<leader>/", ":CommentToggle<CR>", kopts)

-- replace text (simulates multiple cursors)
vim.api.nvim_set_keymap("x", "<leader>r*", '"sy:let @/=@s<CR>cgn', kopts)
vim.api.nvim_set_keymap("n", "<leader>1", ":BufferGoto 1<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>2", ":BufferGoto 2<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>3", ":BufferGoto 3<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>4", ":BufferGoto 4<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>5", ":BufferGoto 5<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>6", ":BufferGoto 6<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>7", ":BufferGoto 7<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>8", ":BufferGoto 8<cr>", kopts)
vim.api.nvim_set_keymap("n", "<leader>9", ":BufferGoto 9<cr>", kopts)
