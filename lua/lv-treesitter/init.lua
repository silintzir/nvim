...
local textobj_move_keymaps = {
    enable = O.plugin.ts_textobjects.active,
...
treesitter_configs.setup {
    ...
    textobjects = {
        swap = {enable = O.plugin.ts_textobjects.active, swap_next = textobj_swap_keymaps},
        move = textobj_move_keymaps,
        select = {enable = O.plugin.ts_textobjects.active, keymaps = textobj_sel_keymaps}
    },
    textsubjects = {
